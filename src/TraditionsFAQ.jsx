          ...
          <div className="space-y-4 text-left">
            <details className="bg-white rounded-lg shadow p-4">
              <summary className="cursor-pointer">
                <h2 className="text-xl font-semibold text-gray-800">What is a “Tradition” page?</h2>
              </summary>
            ...
            <details className="bg-white rounded-lg shadow p-4">
              <summary className="cursor-pointer">
                <h2 className="text-xl font-semibold text-gray-800">How do photo reviews work?</h2>
              </summary>
            ...
            <details className="bg-white rounded-lg shadow p-4">
              <summary className="cursor-pointer">
                <h2 className="text-xl font-semibold text-gray-800">My page looks empty—how do I improve it?</h2>
              </summary>
            ...
            <details className="bg-white rounded-lg shadow p-4">
              <summary className="cursor-pointer">
                <h2 className="text-xl font-semibold text-gray-800">What happens when someone taps “Add to Plans”?</h2>
              </summary>
            ...
            <details className="bg-white rounded-lg shadow p-4">
              <summary className="cursor-pointer">
                <h2 className="text-xl font-semibold text-gray-800">Where do Traditions appear on the site?</h2>
              </summary>
            ...
            <details className="bg-white rounded-lg shadow p-4">
              <summary className="cursor-pointer">
                <h2 className="text-xl font-semibold text-gray-800">Is there any cost?</h2>
              </summary>
              <p className="mt-2 text-gray-700 leading-relaxed">No.</p>
            </details>
            <details className="bg-white rounded-lg shadow p-4">
              <summary className="cursor-pointer">
                <h2 className="text-xl font-semibold text-gray-800">I’m unhappy with my page or need edits/support—how do I reach you?</h2>
              </summary>
