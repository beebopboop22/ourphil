          ...
          <div className="grid gap-12 lg:grid-cols-2">
            ...
            <div>
              ...
              {loading ? (
                ...
                <div className="-mx-4 sm:mx-0">
                  <ul className="flex gap-5 overflow-x-auto pb-4 px-4 sm:px-0">
                    {allGroups.map(group => (
                      <li
                        key={group.id}
                        className="bg-white border border-gray-100 rounded-xl shadow-sm hover:shadow transition shrink-0 w-80 sm:w-[28rem]"
                      >
                        <Link
                          to={`/groups/${group.slug}`}
