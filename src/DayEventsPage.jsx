        ...
        <section className="border-b border-[#f4c9bc]/70 bg-white/80">
          <div className="mx-auto max-w-7xl px-6 pt-14 pb-10 space-y-8">
            <div className="flex flex-col gap-4">
              ...
              <p className="text-base leading-relaxed text-[#4a5568] sm:text-lg">{summary}</p>
              <div className="flex flex-wrap items-center gap-3 text-xs font-semibold uppercase tracking-[0.3em] text-[#9a6f62]">
                <span>{rangeLabel}</span>
                <Link
                  to={mapHref}
                  className="inline-flex items-center gap-2 rounded-full border border-[#bf3d35]/30 bg-white/80 px-4 py-2 text-[11px] font-semibold tracking-[0.25em] text-[#bf3d35] shadow-sm transition hover:border-[#bf3d35] hover:bg-[#f7e5de]"
                >
                  View full map
                  <MapPin className="h-3 w-3" aria-hidden="true" />
                </Link>
              </div>
              <p className="text-xs text-[#9a6f62]">{mapCalloutMessage}</p>
            </div>
