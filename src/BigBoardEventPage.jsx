...
export default function BigBoardEventPage() {
  ...
  useEffect(() => {
    ...
    const measure = () => {
      ...
      setStickyOffset(navHeight + tagHeight + 16);
    };
  ...
  const externalActionClasses =
    'inline-flex w-full max-w-sm items-center justify-center gap-2 rounded-full bg-indigo-600 px-6 py-3 text-base font-semibold text-white shadow-sm transition hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2';
            ...
            <div className="hidden min-w-[240px] flex-col gap-2 md:flex md:items-end">
              {eventLink && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`${externalActionClasses} md:max-w-full`}
                >
                  <ExternalLink className="h-5 w-5" />
                  See original listing
                </a>
