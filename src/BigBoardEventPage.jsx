...
export default function BigBoardEventPage() {
  ...
  const areaLabel = area?.short_name || area?.name || event?.area_name || '';
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <main className="flex-grow bg-white pt-28 pb-24">
        <header className="sticky top-[88px] z-30 px-4 sm:top-[96px] lg:top-[108px]">
          <div className="relative">
            ...
            <div className="relative mx-auto flex max-w-5xl flex-col gap-4 py-6 lg:flex-row lg:items-center lg:justify-between">
      ...
      {!isEditing && (
        <div className="fixed inset-x-0 bottom-0 z-40 border-t border-gray-200 bg-white/95 px-4 py-4 shadow-[0_-4px_12px_rgba(0,0,0,0.08)] backdrop-blur md:hidden">
          <button
            type="button"
            onClick={handleFavorite}
            disabled={favLoading}
