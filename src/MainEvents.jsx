  ...
  const card = (
    ...
    >
      <div className="relative aspect-[4/5] w-full bg-gray-100">
        ...
        <div className="absolute left-3 top-3 rounded-full bg-white/90 px-3 py-1 text-xs font-semibold uppercase tracking-[0.25em] text-indigo-700">
          {label}
        </div>
      ...
      <div className="flex flex-1 flex-col items-center px-6 pb-6 pt-5 text-center">
        <div className="flex-1">
          ...
          {event.venues?.name ? (
            <p className="mt-2 text-sm text-gray-600">at {event.venues.name}</p>
          ) : event.address ? (
    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1 pb-16">
        ...
        <section
          ...
          className="mt-0 overflow-hidden bg-slate-900 text-white"
