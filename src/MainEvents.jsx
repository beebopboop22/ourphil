          ...
          return (
            ...
            {({ isFavorite, toggleFavorite, loading }) => (
              ...
              <div className="p-4 flex-1 flex flex-col justify-between items-center text-center">
                ...
                {evt.isBigBoard && (
                  <div className="mt-4 w-full bg-purple-200 text-purple-900 p-2 rounded">
                    <div className="text-[0.6rem] uppercase font-semibold text-center">SUBMITTED BY</div>
                    <div className="mt-1 flex items-center justify-center gap-2">
                      {profileMap[evt.owner_id]?.image ? (
                        <img
                          src={profileMap[evt.owner_id].image}
                          alt="User avatar"
                      ...
                      <div className="flex items-center gap-1">
                        <span className="font-semibold text-sm">
                          {profileMap[evt.owner_id]?.username}
                        </span>
