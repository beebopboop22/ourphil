...
function formatFeaturedCommunityDateLabel(startDateStr) {
  if (!startDateStr) return '';
  const startDate = parseISODateInPhilly(startDateStr);
  if (!startDate) return '';
...
function EventCard({ event, tags = [], showDatePill = false }) {
  ...
  const datePillLabel = showDatePill ? formatFeaturedCommunityDateLabel(event.start_date) : '';
