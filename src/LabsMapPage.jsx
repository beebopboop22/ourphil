      ...
      try {
        ...
        if (startIso && endIso) {
          const overlapClause = [
            ...
            `and(end_date.not.is.null,start_date.lte.${endIso},end_date.gte.${startIso})`,
            `and(start_date.is.null,end_date.not.is.null,end_date.gte.${startIso})`,
          ].join(',');
          bigBoardQuery = bigBoardQuery.or(overlapClause);
        }

        bigBoardQuery = bigBoardQuery.order('start_date', { ascending: true }).limit(400);
