...
function MapEventRow({ event, onHighlight }) {
  ...
  const titleClassName = `mt-2 font-semibold text-slate-100 group-hover:text-emerald-200 ${
        ...
        <div className="flex flex-col gap-4 p-4 sm:flex-row sm:items-center sm:justify-between sm:p-6">
          <div className="flex w-full items-start gap-4">
            ...
            <div className="min-w-0 flex-1">
              {badgeLabel ? (
                <span className="inline-flex items-center gap-1 rounded-full bg-emerald-500/15 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.2em] text-emerald-200">
                  {badgeLabel}
                </span>
              ) : null}
