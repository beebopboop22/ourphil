...
const globalToken =
  (typeof globalThis !== 'undefined' &&
    (globalThis.MAPBOX_TOKEN || globalThis.MAPBOX_ACCESS_TOKEN || globalThis.VITE_MAPBOX_TOKEN)) ||
  '';

const MAPBOX_TOKEN = mapboxgl.accessToken || envToken || globalToken || '';
...
function LabsMapPage() {
  ...
  const filteredEvents = useMemo(() => {
    return events.filter(event => {
      ...
      if (rangeStart && rangeEnd && event.startDate && event.endDate) {
