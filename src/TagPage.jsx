...
function isTagActive(tag) {
  ...
  if (tag.rrule) {
    try {
      ...
      if (tag.start_date) opts.dtstart = parseISODateLocal(tag.start_date)
  ...
  if (tag.start_date && tag.end_date) {
    const start = parseISODateLocal(tag.start_date)
    const end = parseISODateLocal(tag.end_date)
