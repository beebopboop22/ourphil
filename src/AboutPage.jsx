      ...
      <div className="flex flex-col min-h-screen">
        ...
        <main className="container mx-auto px-4 py-12 flex-grow mt-32">
          ...
          <section className="mt-12 text-center">
            <h2 className="text-2xl font-[Barrio] text-indigo-900 mb-4">FAQs</h2>
            <ul className="space-y-2">
              <li>
                <Link to="/traditions-faq" className="text-indigo-600 underline">Traditions FAQ</Link>
              </li>
              <li>
                <Link to="/groups-faq" className="text-indigo-600 underline">Groups FAQ</Link>
              </li>
            </ul>
          </section>
        </main>
