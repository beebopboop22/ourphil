...
export default function UpcomingPlansCard() {
  ...
  return (
    <div className="h-screen bg-neutral-900 flex justify-center p-2">
      <div
        id="plans-card"
        className="relative bg-white w-full h-full max-w-sm rounded-lg shadow flex flex-col px-4 pt-10 pb-4"
      >
        <button
          onClick={() => navigate(-1)}
