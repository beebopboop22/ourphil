...
export default function BigBoardEventsGrid() {
  ...
  // URL of the “stranger submission” icon
  ...
  const dayDiff = (date) => {
    ...
    return Math.floor((new Date(date) - today) / (1000*60*60*24))
  }
  ...
  useEffect(() => {
    ;(async () => {
      ...
      if (error) {
        ...
        // resolve each flyer’s public URL
  ...
  return (
    <div className="w-full max-w-screen-xl mx-auto mb-12 px-4">
      ...
      <p className="text-gray-600 text-sm mb-4 text-left">
        Community-posted fliers — add yours to the Big Board
      </p>
