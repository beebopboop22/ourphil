    ...
    (async () => {
      try {
        ...
        const { data, error } = await supabase
          .from('events')
          .select('id, slug, "E Name", Dates, "End Date", "E Image", "E Description", neighborhood, "Neighborhood", area_id, start_time')
        ...
        const upcoming = (data || [])
          .map(row => {
            ...
            const neighborhood = row.neighborhood?.trim() || row['Neighborhood']?.trim() || '';
