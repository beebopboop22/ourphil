  ...
  return (
    <div className="min-h-screen bg-[#bf3e35] text-white">
      <div className="relative">
          ...
          <div className="absolute inset-0 z-10">
            {pillConfigs.map((pill, index) => (
              <span
                ...
                className="absolute top-[-3rem] rounded-full px-4 py-2 text-lg font-semibold text-white opacity-90 whitespace-nowrap select-none"
                style={{
                  left: `${pill.left}%`,
        ...
        <div className="relative z-20 mx-auto max-w-md px-4 pt-10 pb-8">
      ...
      <style>{`
        @keyframes traditions-pill-fall {
          to {
